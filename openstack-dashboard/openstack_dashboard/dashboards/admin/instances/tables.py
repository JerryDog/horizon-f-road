...
class MigrateInstance(policy.PolicyTargetMixin, tables.LinkAction):
    name = "migrate"
    verbose_name = _("Cold Migrate")
    url = "horizon:admin:instances:migrate"
    classes = ("ajax-modal", "btn-migrate", "btn-danger")
    policy_rules = (
    ("compute", "compute_extension:admin_actions:migrate"),)
